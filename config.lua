...
MailConfig.DeliveryAreaWide = {
    ["Grapeseed"] = vector3(2643.8, 4784.91, 33.52),
    ["Sandy Shores"] = vector3(1540.14, 3137.63, 40.43),
    ["Paleto Bay"] = vector3(-69.5, 5955.26, 128.92)
}

MailConfig.DutyPosition = vector3(-427.28, 6130.83, 28.48)
MailConfig.RentalPosition = vector3(-411.67, 6181.37, 28.48)

MailConfig.DutyColor = vector4(255, 92, 133.0, 255)

MailConfig.RentalPrice = 2000
MailConfig.RentalBlipSprite = 67 -- See https://docs.fivem.net/docs/game-references/blips/#blips
MailConfig.RentalBlipColor = 0 -- See https://docs.fivem.net/docs/game-references/blips/#blip-colors

MailConfig.JobCooldown = 30000
MailConfig.JobBlipSprite = 67
MailConfig.JobBlipColor = 0

MailConfig.VanModel = "BOXVILLE4"
MailConfig.DeliveryBlipSprite = 164
MailConfig.DeliveryBlipColor = 66